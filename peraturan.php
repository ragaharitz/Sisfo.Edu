...
<head>
  ...
  <meta charset="utf-8">
    ...
    <div class="card-deck" style="width: 35rem margin-left: 50px">
        <div class="card" style="margin-top: 50px">
            
            <div class="card-body">
                <h5 class="card-title" style="text-align: center">Tata Tertib</h5>
                <p class="card-text" style="text-align: center"> Silahkan Download File Tata Tertib dibawah ini </p>
            </div>
            <div class="card-footer"  style="text-align: center">
             <a class = "active" href = "soppengajar.php"  > Download Tata Tertib Pengajar </a>
             <a style="margin-left: 70px"></a>
              <a class = "active" href = "sopmurid.php"> Download Tata Tertib Murid</a> 
            </div>
    </div>
    ...
    <div class="footer" style="background-color: red; width:1365px; height: 80px; margin-top:400px"></div>
</body>
</html>